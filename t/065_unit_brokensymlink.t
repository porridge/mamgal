...
package MaMGal::Unit::Entry::BrokenSymlink;
use strict;
use warnings;
use Carp 'verbose';
use Test::More;
...
sub class_setting : Test(startup) {
	my $self = shift;
	$self->{class_name} = 'MaMGal::Entry::BrokenSymlink';
...
##lives_ok(sub { MaMGal::Formatter->new->entry_cell($n) },                 "BrokenSymlink can be interrogated as an entry cell target");

MaMGal::Unit::Entry::BrokenSymlink->runtests unless defined caller;
1;
