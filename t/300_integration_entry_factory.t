...
my ($mf, $mw, $mp, $mif) = (get_mock_formatter, get_mock_mplayer_wrapper, get_mock_datetime_parser, get_mock_iif);
dies_ok(sub { MaMGal::EntryFactory->new($mf, $mw, $mp) },                "EF cannot be instantiated with just formatter, wrapper, parser");
lives_ok(sub { $ef = MaMGal::EntryFactory->new($mf, $mw, $mp, $mif) },   "EF can be instantiated with formatter, wrapper, parser and image info factory");
my $e;
