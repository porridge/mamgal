...
dies_ok(sub { MaMGal::EntryFactory->new($mf, $mw, $mif) },               "EF cannot be instantiated with just formatter, wrapper and image info factory");
lives_ok(sub { $ef = MaMGal::EntryFactory->new($mf, $mw, $mif, $ml) },   "EF can be instantiated with formatter, wrapper, parser, image info factory and logger");
my $e;
