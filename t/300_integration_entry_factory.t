...
my ($mf, $mw, $mp) = (get_mock_formatter, get_mock_mplayer_wrapper, get_mock_datetime_parser);
lives_ok(sub { $ef = MaMGal::EntryFactory->new($mf, $mw, $mp) },         "EF can be instantiated with formatter, wrapper, parser");
my $e;
