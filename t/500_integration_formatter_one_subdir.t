...
my $d = MaMGal::EntryFactory->new($f, get_mock_mplayer_wrapper, get_mock_datetime_parser, MaMGal::ImageInfoFactory->new(get_mock_datetime_parser))->create_entry_for('td/one_dir');
$d->set_root(1);
my $t = $f->format($d);
