...
isa_ok($e, 'MMGal::Entry::NonPicture');
...
isa_ok($e, 'MMGal::Entry::BrokenSymlink');

lives_ok(sub { $e = MMGal::EntryFactory->create_entry_for('td/one_pic/a1.png') },
											"EF creates entry from a picture");
